{
  ...
  let
    ...
    homeConfigs = self.homeConfigurations;
  in
  {
    legacyPackages.${system} = pkgs;
    nixosConfigurations = import ./hosts { inherit nixosSystem pkgs grub2-theme nixos-hardware home-manager nixvim homeConfigs; };
